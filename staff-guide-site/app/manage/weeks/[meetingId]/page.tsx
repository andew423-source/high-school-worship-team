...
export default async function WeekDetail({ params }: { params: Promise<{ meetingId: string }> }) {
  ...
  const canEditStage = user.role === "admin" || user.role === "group_staff";
  const items = [
